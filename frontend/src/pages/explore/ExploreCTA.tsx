  ...
  return (
    <section className="py-16 bg-near-black border-t-2 border-black">
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <Link
          to="/app"
          className="cursor-pointer shrink-0 flex items-center gap-2 bg-white text-near-black border-2 border-white font-display font-bold px-6 py-3 rounded-md shadow-[4px_4px_0px_rgba(255,255,255,0.2)] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all"
        >
          <Sparkles size={16} />
