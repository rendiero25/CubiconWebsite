...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-off-white">
      ...
      {/* Header */}
      <section className="py-8 md:py-12 border-b-2 border-near-black bg-off-white">
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/app"
              className="border-2 border-near-black font-display font-bold text-sm px-4 py-2 rounded-md bg-off-white text-near-black shadow-[2px_2px_0_near-black] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all flex items-center gap-1.5"
            >
      ...
      {/* Tabs */}
      <div className="border-b-2 border-near-black bg-off-white sticky top-16 z-40">
          ...
          {([['history', 'History', LayoutGrid], ['settings', 'Settings', Settings], ['profile', 'Profile', User]] as const).map(([key, label, Icon]) => (
            <button
              ...
              className={clsx(
                ...
                tab === key
                  ? 'border-electric-yellow text-electric-yellow'
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16">
                    ...
                    {anySelected && (
                      <>
                        <button
                          ...
                          className="cursor-pointer flex items-center gap-1.5 border-2 border-near-black rounded-md px-3 py-1.5 font-body text-xs font-medium bg-off-white hover:bg-light-green transition-colors shadow-[2px_2px_0_near-black] disabled:opacity-50 disabled:cursor-not-allowed"
                        >
              ...
              {error ? (
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                  {Array.from({ length: 15 }).map((_, i) => (
                    <div key={i} className="border-2 border-near-black rounded-md bg-off-white shadow-[3px_3px_0_near-black] overflow-hidden animate-pulse">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                  {icons.map((icon) => (
                    <div
                      key={icon.id}
                      className={clsx(
                        'border-2 rounded-md bg-off-white overflow-hidden group',
                        icon.selected
                    ...
                    >
                      <div className="relative bg-light-green aspect-square flex items-center justify-center border-b-2 border-near-black">
                        ...
                        <div
                          className={clsx(
                            ...
                            icon.selected ? 'bg-electric-yellow' : 'bg-off-white/80'
                          )}
                          onClick={() => toggleSelect(icon.id)}
                        >
                          {icon.selected && <span className="text-off-white text-xs font-bold">✓</span>}
                        </div>
                        {/* Visibility badge */}
                        <div className="absolute bottom-2 left-2">
                          {icon.is_public
                            ? <span className="flex items-center gap-1 bg-off-white border-2 border-near-black rounded px-1.5 py-0.5 font-body text-[10px] font-semibold"><Globe size={10} /> Public</span>
                            : <span className="flex items-center gap-1 bg-off-white border-2 border-near-black rounded px-1.5 py-0.5 font-body text-[10px] font-semibold"><Lock size={10} /> Private</span>
                          }
                        </div>
                      </div>
                      ...
                      <div className="p-3 flex flex-col gap-2">
                        ...
                        <Link
                          ...
                          className="flex items-center justify-center gap-1.5 border-2 border-near-black rounded-md py-1.5 font-display font-bold text-[10px] bg-off-white shadow-[2px_2px_0_near-black] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all"
                        >
                        ...
                        <div className="flex gap-1.5">
                          <button
                            ...
                            className="cursor-pointer flex-1 flex items-center justify-center gap-1 border-2 border-near-black rounded-md py-1.5 font-body text-[10px] font-medium bg-off-white shadow-[2px_2px_0_near-black] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                          >
          ...
          {tab === 'profile' && (
            <div className="max-w-lg flex flex-col gap-5">
              {/* Avatar + name card */}
              <div className="border-2 border-near-black rounded-md bg-off-white shadow-[4px_4px_0_near-black] p-6 flex flex-col items-center gap-4">
                <div className="w-20 h-20 bg-electric-yellow border-2 border-near-black rounded-full flex items-center justify-center shadow-[3px_3px_0_near-black]">
                  <span className="font-display font-bold text-2xl text-off-white">
                    ...
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="cursor-pointer flex items-center gap-1 border-2 border-near-black rounded-md px-3 py-1 font-body text-xs bg-off-white hover:bg-light-green transition-colors"
                        >
                          <XIcon size={12} /> Batal
                        </button>
                      </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  <div key={label} className="border-2 border-near-black rounded-md bg-off-white shadow-[3px_3px_0_near-black] p-4 text-center">
              ...
              {/* Account details */}
              <div className="border-2 border-near-black rounded-md bg-off-white shadow-[4px_4px_0_near-black] p-6 flex flex-col gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center justify-between py-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Link to="/pricing" className="font-body text-xs font-medium text-electric-yellow underline underline-offset-2">
                        Beli lagi
                      </Link>
                    </div>
                  </div>
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  {([['1K', CREDIT_COST['1K']], ['2K', CREDIT_COST['2K']], ['4K', CREDIT_COST['4K']]] as const).map(([res, cost]) => (
                    <div key={res} className="border-2 border-near-black rounded-md bg-off-white shadow-[4px_4px_0_near-black] p-5">
                ...
                {/* Top-up credit card */}
                <div className="border-2 border-near-black rounded-md bg-off-white shadow-[4px_4px_0_near-black] p-5">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <input
                      ...
                      className="border-2 border-near-black rounded-md px-3 py-2 font-body text-sm text-near-black bg-off-white focus:outline-none focus:border-electric-yellow w-full sm:max-w-xs"
                    />
                    <button
                      onClick={handleTopUp}
                ...
                <div className="border-2 border-near-black rounded-md bg-off-white shadow-[4px_4px_0_near-black] overflow-hidden">
                  <div className="flex flex-wrap items-center gap-3 px-5 py-4 border-b-2 border-near-black bg-yellow-50">
                    ...
                    <div className="flex gap-2 ml-auto items-center">
                      <span className="font-body text-xs font-medium border-2 border-near-black rounded-md px-2.5 py-1 bg-off-white">
                      ...
                      {totalPages > 1 && (
                        <div className="flex items-center justify-between px-5 py-3 border-t-2 border-near-black bg-near-black/5">
                          <button
                            ...
                            className="cursor-pointer flex items-center gap-1 border-2 border-near-black rounded-md px-3 py-1.5 font-body text-xs font-medium bg-off-white shadow-[2px_2px_0_near-black] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all disabled:opacity-40 disabled:cursor-not-allowed disabled:translate-x-0 disabled:translate-y-0 disabled:shadow-[2px_2px_0_near-black]"
                          >
