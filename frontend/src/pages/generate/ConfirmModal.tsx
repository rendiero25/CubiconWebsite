...
export default function ConfirmModal({ form, credits, isAdmin, onCancel, onConfirm }: Props) {
  ...
  return (
    ...
    >
      <div className="bg-off-white border-2 border-near-black rounded-md shadow-[8px_8px_0px_near-black] w-full max-w-sm">
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-4 border-b-2 border-near-black">
        ...
        <div className="px-5 pb-5 flex gap-3">
          ...
          <button
            ...
            disabled={!canAfford}
            className={clsx(
              'cursor-pointer flex-1 font-display font-bold text-sm py-2.5 border-2 border-near-black rounded-md transition-all',
              canAfford
                ...
                : 'bg-electric-yellow/40 text-near-black cursor-not-allowed',
            )}
          >
            Generate Now ✨
          </button>
